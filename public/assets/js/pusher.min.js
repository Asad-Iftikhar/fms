...
!function (t, e) {
    ...
    return function (t) {
        ...
        var r, o = function () {
            ...
            return t.prototype.load = function (t, e, n) {
                ...
                if (r.loading[t] && r.loading[t].length > 0) r.loading[t].push(n); else {
                    r.loading[t] = [n];
                    var o = Se.createScriptRequest(r.getPath(t, e)), i = r.receivers.create((function (e) {
        ...
        var Z = new (function () {
            ...
            return t.prototype.send = function (t) {
                if (!this.request) {
                    var e = $(this.data), n = this.url + "/" + t.number + "?" + e;
            ...
            name: "jsonp", getAgent: function (t, e) {
                return function (n, r) {
                    var o = "http" + (e ? "s" : "") + "://" + (t.host || t.options.host) + t.options.path,
                        s = Se.createJSONPRequest(o, n), c = Se.ScriptReceivers.create((function (e, n) {
        ...
        }, _t = {ws: yt, xhr_streaming: new dt(z({}, vt, mt)), xhr_polling: new dt(z({}, bt, mt))}, wt = new dt({
            file: "sockjs",
            urls: at,
        ...
        }, kt = new dt(z({}, vt, St)), Ct = new dt(z({}, bt, St));
        _t.xdr_streaming = kt, _t.xdr_polling = Ct, _t.sockjs = wt;
        var Tt = _t, Pt = function () {
            var t = function (e, n) {
                return (t = Object.setPrototypeOf || {__proto__: []} instanceof Array && function (t, e) {
                    t.__proto__ = e
                } || function (t, e) {
            ...
            return xt(e, t), e.prototype.handlesActivityChecks = function () {
                ...
                var e = Lt.getCloseAction(t), n = Lt.getCloseError(t);
            ...
            return t.prototype.close = function () {
                ...
                this.onMessage = function (e) {
                    ...
                    t.unbindListeners();
                    var n = Lt.getCloseAction(e) || "backoff", r = Lt.getCloseError(e);
                    t.finish(n, {error: r})
            ...
            return t.prototype.isSupported = function () {
                ...
                if (r && r.timestamp + this.ttl >= U.now()) {
                    ...
                    i && (this.timeline.info({
                        ...
                        latency: r.latency
                    }), o.push(new $t([i], {timeout: 2 * r.latency + 1e3, failFast: !0})))
                }
                var s = U.now(), c = o.pop().connect(t, (function r(i, a) {
                    i ? (ne(n), o.length > 0 ? (s = U.now(), c = o.pop().connect(t, r)) : e(i)) : (!function (t, e, n) {
                        var r = Se.getLocalStorage();
                        if (r) try {
                            r[ee(t)] = K({timestamp: U.now(), transport: e, latency: n})
                        } catch (t) {
                        }
        ...
        var ce, ae = function (t, e, n) {
            ...
            var i, s = Object.assign({}, e, {
                ...
                h = new Yt({lives: 2, minPingDelay: 1e4, maxPingDelay: t.activityTimeout}),
                p = new Yt({lives: 2, minPingDelay: 1e4, maxPingDelay: t.activityTimeout}), l = o("ws", "ws", 3, s, h),
                f = o("wss", "ws", 3, c, h), d = o("sockjs", "sockjs", 1, a),
                y = o("xhr_streaming", "xhr_streaming", 1, a, p), g = o("xdr_streaming", "xdr_streaming", 1, a, p),
                v = o("xhr_polling", "xhr_polling", 1, a), b = o("xdr_polling", "xdr_polling", 1, a),
                m = new $t([l], u), _ = new $t([f], u), w = new $t([d], u), S = new $t([new oe(se(y), y, g)], u),
                k = new $t([new oe(se(v), v, b)], u),
                C = new $t([new oe(se(S), new Kt([S, new re(k, {delay: 4e3})]), k)], u), T = new oe(se(C), C, w);
            return i = e.useTLS ? new Kt([m, new re(T, {delay: 2e3})]) : new Kt([m, new re(_, {delay: 2e3}), new re(T, {delay: 5e3})]), new te(new ie(new oe(se(l), i, T)), r, {
                ttl: 18e5,
                timeline: e.timeline,
                useTLS: e.useTLS
            })
        ...
        var ke = ge, Ce = function () {
            function t(t, e, n) {
                this.key = t, this.session = e, this.events = [], this.options = n || {}, this.sent = 0, this.uniqueID = 0
            }

            return t.prototype.log = function (t, e) {
                t <= this.options.level && (this.events.push(z({}, e, {timestamp: U.now()})), this.options.limit && this.events.length > this.options.limit && this.events.shift())
        ...
        var Oe = Se.Transports, Ee = function (t, e, n, r, o, i) {
            var s, c = Oe[n];
            if (!c) throw new _(n);
            return !(t.enabledTransports && -1 === B(t.enabledTransports, e) || t.disabledTransports && -1 !== B(t.disabledTransports, e)) ? (o = Object.assign({ignoreNullOrigin: t.ignoreNullOrigin}, o), s = new Te(e, r, i ? i.getAssistant(c) : c, o)) : s = Ae, s
        }, Ae = {
            isSupported: function () {
                return !1
        ...
        var ze = function () {
            ...
            return ze(e, t), e.prototype.signin = function () {
                ...
                if (this.signin_requested && "connected" === this.pusher.connection.state) {
                    this.pusher.config.userAuthenticator({socketId: this.pusher.connection.socket_id}, (function (e, n) {
            ...
            function t(e, n) {
                ...
                this.connection = Qt.createConnectionManager(this.key, {
                    ...
                    Z.warn(t)
                })), t.instances.push(this), this.timeline.info({instances: t.instances.length}), this.user = new qe(this), t.isReady && this.connect()
            }
            ...
            return t.ready = function () {
                ...
                return X(V({ws: Se.Transports.ws}, (function (t) {
                    return t.isSupported({})
                })))
