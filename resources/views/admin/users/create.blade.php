            ...
            <form class="form form-vertical" method="post" action="{{ url('admin/users/create') }}">
                ...
                <div class="form-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="basicInput">Password &nbsp;&nbsp;<small class="text-danger"> Required *</small></label>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="basicInput">Confirm Password &nbsp;&nbsp;<small class="text-danger"> Required *</small></label>
